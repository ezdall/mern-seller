        ...
        <Card className={classes.card}>
          ...
          <div className={classes.root}>
            <ImageList className={classes.gridList} cols={4}>
              {categories.length && categories.map((tile,i) => (
                <ImageListItem key={tile.i} className={classes.tileTitle} style={{height: '64px', backgroundColor: selected === tile? 'rgba(95, 139, 137, 0.56)':'rgba(95, 124, 139, 0.32)'}}>
