    ...
    return (<div>
      <Card className={classes.card}>
        <CardContent>
          ...
          <TextField id="name" label="Name" className={classes.textField} required name="name" value={values.name} onChange={handleChange} margin="normal"/><br/>
          <TextField
          ...
          <TextField id="quantity" label="Quantity" className={classes.textField} required name="quantity" value={values.quantity} onChange={handleChange} type="number" margin="normal"/><br/>
          <TextField id="price" label="Price" className={classes.textField} required name="price" value={values.price} onChange={handleChange} type="number" margin="normal"/><br/>
          {
        ...
        <CardActions>
          ...
          <Link to={`/seller/shop/edit/${params.shopId}`} className={classes.submit}><Button variant="contained">Cancel</Button></Link>
        </CardActions>
      </Card>
    </div>)
}
