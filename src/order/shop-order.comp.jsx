...
export default function ShopOrder({match}) {
  ...
  // 
  // const myList = forwardRef((props, ref) => <li ref={ref} {...props} />)
          ...
          {orders.map((order, index) => {
            return   <span key={order._id}>
              <ListItem button onClick={handleClick(index)}>
                <ListItemText primary={`Order # ${order._id}`} secondary={(new Date(order.createdAt)).toDateString()}/>
